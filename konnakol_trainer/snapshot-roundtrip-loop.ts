...
function buildMidiInputFromSnapshot(snapshot: CompactSnapshot): MidiExportInput {
  ...
  // Multipliers are derived by decoder policy, not copied from snapshot token.
